...
public class KafkaConsumerOperator extends AbstractKafkaOperator {
    ...
    public void checkpoint(Checkpoint checkpoint) throws Exception {
        ...
        consumer.sendCheckpointEvent(checkpoint); // blocks until checkpoint
                                                    // completes
        consumer.sendStartPollingEvent(consumerPollTimeout); // checkpoint is
                                                                // done, resume
                                                                // polling for
                                                                // records
    }
    ...
    public void reset(Checkpoint checkpoint) throws Exception {
        ...
        consumer.sendStartPollingEvent(consumerPollTimeout); // done resetting,
                                                                // start polling
                                                                // for records
    ...
    public void resetToInitialState() throws Exception {
        ...
        consumer.sendStartPollingEvent(consumerPollTimeout); // done resettings,
                                                                // start polling
                                                                // for records
