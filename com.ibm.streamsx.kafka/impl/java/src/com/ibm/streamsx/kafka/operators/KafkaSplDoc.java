...
public class KafkaSplDoc {
    ...
    public static final String CONSUMER_COMMITTING_OFFSETS = ""
            ...
            + "those Kafka messages, which have been submitted as tuples. There are two reasons to commit offsets:\\n"
            + "\\n"
            ...
            + "If nothing is specified, offsets are committed every 10 seconds. The time period can be specified with the "
            ...
            + "When the operator is in a consistent region, the parameter **commitCount** is ignored because the commit frequency is given "
    ...
    public static final String CONSUMER_RESTART_BEHAVIOUR = ""
            ...
            + "\\n"
            + "When a consumer operator is not part of a consumer group (no group identifier "
            + "specified, partitions are given, or **startPosition** is not `Default`), i.e. a single "
            + "consumer is pinned to topic partitions, all partitions will be seeked to what **startPosition** is.\\n"
            + "\\n"
    ...
    //            + "\\n"
    //            + "When a consumer operator is not part of a consumer group (no group identifier "
    //            + "specified or partitions specified), i.e. a single "
    //            + "consumer is pinned to topic partitions, there is no need for inter-operator "
    //            + "coordination. In this case a `JobControlPlane` operator in the application graph is "
    ...
    public static final String CONSUMER_KAFKA_GROUP_MANAGEMENT = ""
            ...
            + "must be met\\n"
            + "\\n"
            // if (Features.ENABLE_NOCR_CONSUMER_GRP_WITH_STARTPOSITION == false) {
            ...
            + "\\n"
            // }
            // if (Features.ENABLE_NOCR_CONSUMER_GRP_WITH_STARTPOSITION == true) {
...
//            + "`JobControlPlane` operator cannot be connected initially, the operator "
//            + "will throw an Exception and restart.\\n"
            // }
            + "\\n"
