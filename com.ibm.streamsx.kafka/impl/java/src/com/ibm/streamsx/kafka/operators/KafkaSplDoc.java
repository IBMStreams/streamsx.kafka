...
public class KafkaSplDoc {
    ...
    public static final String CONSUMER_COMMITTING_OFFSETS = ""
            ...
            + "**commitCount** parameter is reset after rebalance.\\n"
            + "\\n"
            + "**2. Offsets are committed periodically.** The frequency in terms of "
            + "number of tuples can be specified with the **commitCount** parameter. This parameter has a default value of 2000.\\n"
            + "\\n"
