...
public class KafkaSplDoc {
    ...
    public static final String CONSUMER_DEFAULT_AND_ADJUSTED_PROPERTIES = ""
            ...
            + "|---|\\n"
            + "| group.instance.id | when **staticGroupMember** parameter is `true`: hash from instance-ID and operator name. When user provided and used in parallel region, the parallel channel number is added. |\\n"
            + "|---|\\n"
