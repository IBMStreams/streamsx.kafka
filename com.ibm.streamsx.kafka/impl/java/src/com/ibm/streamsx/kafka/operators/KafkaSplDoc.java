...
public class KafkaSplDoc {
    public static final String CONSUMER_CHECKPOINTING_CONFIG = ""
            ...
            + "assignment or the topic subscription changed, i.e. after each input tuple has been processed.\\n"
            + "\\n"
            ;
    ...
    public static final String CONSUMER_DEFAULT_AND_ADJUSTED_PROPERTIES = ""
            ...
            + "|---|\\n"
            + "| group.instance.id | when **staticGroupMember** parameter is `true`: hashes from instance-ID and operator name. When user provided and used in parallel region, the parallel channel number is added. |\\n"
            + "|---|\\n"
    ...
    public static final String CONSUMER_STATIC_GROUP_MEMBERSHIP = ""
            ...
            + "\\n"
            + "**When the version of your Kafka server is below 2.3, this feature is not relevant for you.**\\n"
            + "\\n"
